export const en = {
  ...
  chat: {
    ...
    composerTipText: "Use /create-prompt to generate a reusable prompt file with the agent.",
    composerContext: "Current dashboard chat session",
    composerPlaceholder: "Describe what to build",
    composerAttachTitle: "Insert @ to pick project files",
    composerAgent: "Agent",
    composerAgentTitle: "Only Agent mode is supported in this dashboard",
    composerAutoTitle: "Cycle preset mode (auto/flash/pro)",
    composerSlidersTitle: "Open Settings",
    composerToolsTitle: "Open Tools",
    composerVoiceTitle: "Voice input",
    composerCreatePromptTitle: "Insert /create-prompt command",
    composerVoiceUnavailable: "Voice input is not available in this version.",
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside claude-code code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside claude-code code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in claude-code chat / code / run and refresh.",
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active claude-code code session — standalone claude-code dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart claude-code code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when claude-code code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart claude-code code, then refresh this dashboard.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `claude-code code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.claude/config.json. Restart `claude-code code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
    ...
    pickDesc: "Project CLAUDE.md is committable; global notes live in ~/.claude/memory/.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from claude-code code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with Claude Code; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run claude-code index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "Claude Code doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.claude/config.json — do not share that file.",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. Claude Code will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
